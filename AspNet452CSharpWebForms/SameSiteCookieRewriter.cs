...
namespace AspNet45CSharpWebForms
{
    ...
    {
        public static void FilterSameSiteNoneForIncompatibleUserAgents(object sender, IDictionary<string, string> sameSiteOverrides)
        {
        ...
        private static void SetSameSiteAttribute(HttpCookie c, string sameSiteValue)
        {
